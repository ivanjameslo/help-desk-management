...
import { categorySchema, type CategoryActionState } from "@/lib/validations/category";
...
export async function toggleCategoryStatus(categoryId: string, formData: FormData): Promise<void> {
  await requireRole([UserRole.ADMIN]);
