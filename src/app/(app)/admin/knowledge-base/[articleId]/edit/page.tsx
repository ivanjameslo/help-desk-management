...
export default async function EditKnowledgeArticlePage({ params }: EditKnowledgeArticlePageProps) {
  ...
  return (
    <div className="mx-auto w-full max-w-4xl">
      ...
      <div className="mt-6 sm:mt-8">
        <EditKnowledgeArticleForm article={article} categories={categories} />
      </div>
    </div>
  );
}
