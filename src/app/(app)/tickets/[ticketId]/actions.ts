...
import { updateTicketSchema, type UpdateTicketState } from "@/lib/validations/ticket-management";
...
export async function updateTicket(
   ...
   */
  const currentUser = await requireRole([UserRole.AGENT, UserRole.ADMIN]);
  ...
  const { status, priority, assignedAgentId: submittedAgentId } = validatedFields.data;
