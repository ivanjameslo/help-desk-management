...
export default function TicketNotFound() {
  return (
    <div className="mx-auto w-full max-w-xl min-w-0 rounded-xl border bg-white p-5 text-center shadow-sm sm:p-8">
      ...
      <h1 className="mt-3 wrap-break-word text-xl font-bold text-gray-900 sm:text-2xl 2xl:text-3xl">
        This ticket could not be found
      </h1>

      <p className="mt-3 wrap-break-word text-xs leading-5 text-gray-600 sm:text-sm sm:leading-6 2xl:text-base">
        The ticket may not exist, or your account may not
