...
export function LoginForm() {
  ...
  return (
    <div className="min-w-0 space-y-5 sm:space-y-6">
      {/* Demo login */}
      <form action={demoFormAction} className="min-w-0 space-y-3 sm:space-y-4">
        <div className="min-w-0">
          <h2 className="text-sm font-semibold text-gray-900 sm:text-base">Explore the Demo</h2>

          <p className="mt-1 text-xs leading-5 wrap-break-word text-gray-600 sm:text-sm sm:leading-6">
            Choose an account to explore the help desk without entering credentials.
          </p>
        </div>
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <span className="shrink-0 text-[10px] font-medium tracking-wide text-gray-400 uppercase sm:text-xs">
          Or sign in
        </span>
      ...
      <form action={loginFormAction} className="min-w-0 space-y-4 sm:space-y-5">
        <div className="min-w-0">
          <label htmlFor="email" className="block text-xs font-medium text-gray-900 sm:text-sm">
            Email
          </label>
        ...
        <div className="min-w-0">
          <label htmlFor="password" className="block text-xs font-medium text-gray-900 sm:text-sm">
            Password
          </label>
