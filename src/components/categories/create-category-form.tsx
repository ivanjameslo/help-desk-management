...
export function CreateCategoryForm() {
    ...
    return (
        ...
        >
            ...
            <p className="mt-1 wrap-break-word text-xs leading-5 text-gray-500 sm:text-sm sm:leading-6">
            ...
            <div className="mt-5 space-y-4 sm:mt-6 sm:space-y-5">
                ...
                <div className="min-w-0">
                    ...
                    <textarea 
                        ...
                        className="mt-2 min-h-28 w-full min-w-0 resize-y rounded-lg border border-gray-300 px-3 py-2.5 text-xs text-black outline-none transition placeholder:text-gray-400 focus:border-slate-700 sm:min-h-32 sm:text-sm"
                    />
