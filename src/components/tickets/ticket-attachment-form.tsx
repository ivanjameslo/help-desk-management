        ...
        >
            ...
            <div className="mt-4 sm:mt-5">
                ...
                <input 
                    ...
                    className="
                        mt-2 block w-full min-w-0 rounded-lg border border-gray-300
                        bg-white px-2 py-2 text-xs text-gray-700
                        file:mr-3 file:rounded-md file:border-0 file:bg-slate-100
                        file:px-3 file:py-2 file:text-xs file:font-medium
                        file:text-slate-700 hover:file:bg-slate-200
                        sm:px-3 sm:text-sm
                        sm:file:mr-4 sm:file:text-sm
                    "
                />

                <p
                    id="attachment-help"
                    className="mt-2 wrap-break-word text-[11px] leading-5 text-gray-500 sm:text-xs"
                >
