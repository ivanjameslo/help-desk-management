...
const selectClassName = "w-full appearance-none rounded-lg border border-gray-300 bg-white py-2.5 pl-3 pr-12 text-xs text-black outline-none transition focus:border-slate-700 sm:text-sm 2xl:text-base";
        ...
        <article className="min-w-0 rounded-xl border bg-white p-4 shadow-sm sm:p-6">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div className="min-w-0">
                    ...
                    <p className="mt-2 break-all text-xs text-gray-600 sm:text-sm 2xl:text-base">
                        {user.email}
                    </p>
